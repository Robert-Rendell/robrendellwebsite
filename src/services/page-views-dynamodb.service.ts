...
export class PageViewsDynamoDbService extends DynamoDBService {
  ...
  public static async savePageView(pageViewer: PageViewerDocument): Promise<void> {
  ...
  public static async getPageView(key: string): Promise<PageViewerDocument | undefined> {
    ...
    return AWS.DynamoDB.Converter.unmarshall(attributeMap) as PageViewerDocument;
  }
}
